...
void Converter::RGB2YCbCr(uint8_t* rgb, uint8_t *ycbcr, bool a, bool b, bool c) {
    int     YCbCr[3];
...
void Converter::YCbCr2RGB(uint8_t* ycbcr, uint8_t *rgb, bool a, bool b, bool c) {
...
void Converter::RGB2HSV(uint8_t* rgb, uint8_t *hsv, bool a, bool b, bool c) {
    double MAX = 0, MIN = 0;
    double HSV[3];
    double RGB[3];
...
void Converter::HSV2RGB(uint8_t* hsv, uint8_t *rgb, bool a, bool b, bool c) {
    double  RGB[3];
    double  HSV[3];
